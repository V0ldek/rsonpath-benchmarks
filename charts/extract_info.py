...
id_map = {
    ...
    "author_affiliation" : "C3",
    "author_affiliation_descendant" : "C3r",
    "DOI" : "C1",
    "editor" : "C4",
    "editor_descendant" : "C4r",
    "orcid" : "C5",
    "orcid_descendant" : "C5r",
    "scalability_affiliation2" : "S2",
    "title" : "C2",
    "title_descendant" : "C2r",
    ...
    "TT2_text" : "T2",
    "WM1_items_price" : "Wa1",
    "WM1'_items_price" : "Wa1r",
    "WM2_items_name" : "Wa2",
    "WM2'_items_name" : "Wa2r",
    "WP1_claims_p150" : "Wi",
...
id_queries = {
    ...
    "C3r": "$..author..affiliation..name",
    "C1": "$..DOI",
    "C4": "$.items[*].editor[*].affiliation[*].name",
    "C4r": "$..editor..affiliation..name",
    ...
    "Wa1r": "$..bestMarketplacePrice.price",
    "Wa2": "$.items[*].name",
    "Wa2r": "$..name",
